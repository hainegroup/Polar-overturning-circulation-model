...
% twnh Aug '17, Jan, May, Sep '20

function S_PW = compute_max_PW_salinity(T_1,S_1,geophysical_parameters,static_parameters,static_fns)
...
% Compute:
T_f1  = static_fns.T_freezing(S_1    ,pressure) ;      % Use freezing temperature at temperature T_1.
alpha = static_fns.alpha(     S_1,T_1,pressure) ;
beta  = static_fns.beta(      S_1,T_1,pressure) ;
L1    = L  + c_i.*(T_f1 - T_i) ;
L2    = L1 + c_p.*(T_1 - T_f1) ;
